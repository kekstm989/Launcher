using System.Drawing; // ✅ Добавляем это, чтобы Color работал
...
namespace MinecraftModUpdater
{
    partial class UpdateForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblStatus.ForeColor = Color.White;  // ✅ Чисто белый текст
            this.lblStatus.BackColor = Color.Transparent; // ✅ Фон прозрачный
            ...
            // progressBar
            // 
            this.progressBar.ForeColor = Color.Lime;
            ...
            this.FormBorderStyle = System.Windows.Forms.FormBorderStyle.None; // ✅ Без рамок
